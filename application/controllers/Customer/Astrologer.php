...
class Astrologer extends CI_Controller
{
    ...
    public function index()
    {
		...
		$template['page'] = CUSTOMER_VIEW.'/astrologer/index';
		$template['page_title'] = "Shaktipeethdigital Astrologers";
        ...
        $req_res = $this->nodeserverapi('fetch_astrologers','POST',$req);
        // print_r($req_res);die;
        if(!$req_res->status){
        ...
        $template['self_url'] = base_url().'astrologer-list';
        $template['astrologerdata'] = $req_res->data;
