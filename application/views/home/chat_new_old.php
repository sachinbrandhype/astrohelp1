                                    ...
                                    <div class="chat-header">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="user-name"><?php echo "Varun"; ?></div>
 ...
 -->
    ...
    <script>
        function sendMessage() {
            ...
            //  firebase.database().ref().child("chat/" + '<?php //echo $booking_data->bridge_id; 
                                                            ?>').push().set({
            firebase.database().ref().child("chat/uieruyfrhyurfhhjh3278327467").push().set({
    ...
    <script>
        ...
        firebase.database().ref().child("chat/uieruyfrhyurfhhjh3278327467").on("child_added", function(snapshot) {
