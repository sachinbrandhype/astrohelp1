...
<input type="text" class="form-control" name="name" placeholder="Name" required="required">
    ...
    <input type="date" class="form-control" name="dob" placeholder="Date of Birth" required="">
                ...
                <div class="col-12 col-md-4">
                   <div class="form-group">
          <label class="upload">Consultant <span style="color: red">*</span></label>
    ...
    <input type="text" class="form-control" name="location" placeholder="Address" required="required">
               ...
               <div class="col-12 col-md-4">
                 <div class="form-group">
            <label class="upload">State <span style="color: red">*</span></label>
            ...
            <?php endforeach ?>    
               ...
               <div class="col-12 col-md-4">
                 <div class="form-group">
           <label class="upload">City <span style="color: red">*</span></label>
