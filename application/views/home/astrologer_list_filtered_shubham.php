 ...
 <!-- astrologer Widget -->
         <div class="profile-widget">
           <div class="doc-img">
                   <a href="<?=base_url('home/astrologer_profile/'.$key->id)?>">
                            <img class="img-fluid" style=" height: 300px; " alt="User Image" src="<?= BASE_URL_IMAGE.'astrologers/'.$key->image ?>"></a>
        ...
        <a href="javascript:void(0)" class="fav-btn">
          ...
          <div class="pro-content">
            <h3 class="title">
               <a href="astrologer-profile.html"> <a href="<?=base_url('home/astrologer_profile/'.$key->id)?>"><?=$key->name?></a> </a> 
  ...
  <span class="d-inline-block average-rating">(5.0)</span>
    ...
    <i class="far fa-money-bill-alt"></i> ₹<?=$avgprice?>/Min
        ...
        <div class="row row-sm">
          <div class="col-4">
   <a href="#" class="btn view-btn" data-toggle="modal" data-target="#download-popup"><i class="far fa-comment-alt"></i> ₹<?=$key->price_per_mint_chat+ 0 ?>/Min</a>
              </div>

           <div class="col-4">
   <a href="#" class="btn view-btn-busy" data-toggle="modal" data-target="#download-popup"><i class="fas fa-phone"></i> ₹<?=$key->price_per_mint_audio+ 0?>/Min</a>
              </div>

              <div class="col-4">
   <a href="#" class="btn view-btn" data-toggle="modal" data-target="#download-popup"><i class="fas fa-video"></i> ₹<?=$key->price_per_mint_video+ 0?>/Min</a>
              </div>
              </div>
              </div>
              </div>
